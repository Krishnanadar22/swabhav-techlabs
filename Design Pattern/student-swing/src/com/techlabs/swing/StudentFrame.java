...
public class StudentFrame extends JFrame {
	 ...
	 */
	public StudentFrame() throws FileNotFoundException, ClassNotFoundException,
			IOException {
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!(txtFirstName.getText().isEmpty()
						&& txtLastName.getText().isEmpty() && txtAddress
						.getText().isEmpty())) {
				...
				JOptionPane.showMessageDialog(null, "Student Added", "Message",
